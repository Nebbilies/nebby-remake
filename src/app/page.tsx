...
export default function Home() {
  return (
      <div className={'relative min-h-screen'}>
          ...
          />
          <div className="relative h-screen items-center justify-center w-full bg-cover bg-center lg:bg-cover"
               style={{backgroundImage: 'url("/image/background/our-identity.gif")'}}>
              ...
              <div className="text-primary-content w-full h-full flex z-10 relative">
                  <div className={'w-full lg:w-1/2 flex flex-col justify-center items-center h-full'}>
                      <div className="max-w-xl">
                          <h1 className="mb-5 text-5xl font-bold lg:text-7xl">Hi, <span className={'text-accent'}>Nebby </span> です。</h1>
