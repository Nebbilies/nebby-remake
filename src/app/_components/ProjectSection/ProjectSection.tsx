    ...
    const projects = [
        {
            ...
            description: 'An online bookstore platform which offers various genres of books. Currently supports purchase workflow, book/category creation.',
        ...
        },
        {
            ...
            description: 'A tournament management system for Vietnam osu! Championship. Features include team registration, match scheduling, score tracking, mappool management.',
        ...
        {
            name: 'Electricilies',
            description: 'An e-commerce platform specializing in electronic products. Currently supports purchase workflow, product/category creation.',
        ...
        },
        {
            ...
            description: 'Check out my GitHub for more small projects and experiments I have worked on in my free time. (Discord bots, tournament overlays, etc...)',
            tools: ['GitHub'],
            projectUrl: 'https://github.com/Nebbilies'
        }
    ]
    return (
        <div className="max-w-7xl mx-auto px-5 py-20 min-h-screen h-screen">
