...
export default function AboutSection() {
  ...
  return (
      <div className="max-w-7xl mx-auto px-5 py-20 min-h-screen h-screen">
        ...
        <div className={"w-full h-full flex flex-col md:flex-row gap-10 md:gap-20"}>
          <div className={"relative w-1/2 h-full flex justify-center items-center"}>
            <div className={'absolute w-100 h-100 border-dashed border-neutral-content border-3 rounded-full'}/>
            <div className={'absolute w-103 h-103 border-dashed border-neutral-content/50 border-2 rounded-full'}/>
            ...
            <div className={'flex flex-1 flex-col justify-center'}>
                ...
                <p className="text-lg mb-4">
                    I&#39;m Nebby, a third-year student at University of Information Technology, VNU-HCM, specializing in Software Engineering. I specialize in the <strong className={'text-accent'}>frontend</strong>, primarily using React and Next.js, but love to use whatever tools are right for the job.
                </p>
                <p className="text-lg mb-4">
